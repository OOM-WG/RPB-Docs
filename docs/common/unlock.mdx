...
解锁仅可在机型出厂 UI 大版本下申请，如果进行了大版本更新，则会无法通过审核，需要重新降级！
:::

:::note
部分官方信息不可信，只要申请之后不更换账号、不更新 UI 大版本，理论不会有过期限制

初代 GT 必须更新至 UI **5** 后才可申请
:::
...
<Tabs>
	<TabItem value='mtk-bootloader' label='联发科 BootLoader 界面'>
		![联发科 BootLoader 界面](img/bootloader-mtk.webp)
	</TabItem>
	<TabItem value='qcom-bootloader' label='高通 BootLoader 界面'>
...
<Tabs>
<TabItem value='mtk-unlock' label='联发科解锁方式'>
按压 `音量+键`，确认解锁
...
<TabItem value='qcom-unlock' label='高通解锁方式'>
