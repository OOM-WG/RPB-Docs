...
<Callout type='warn'>联发科处理器机型与高通处理器机型的解锁方式并不相同！请确认好自己机型的处理器厂商！</Callout>
...
<Callout>联发科处理器机型与较新系统版本的高通处理器机型在解锁后每次开机时会显示**几行文字**，**并不影响使用**！</Callout>
